...
MSGS = {
    "العربية 🇮🇶": {
        ...
        "label_news": "🚨 خبر",
        "label_mena": "📰 أخبار الشرق الأوسط ا�لسياسية",
        "label_trending": "🔥",
        "label_sports": "⚽",
        ...
        "sear�ch_results_header": "🔍 *نتائج البحث عن: {query}*",
    ...
    "Русский 🇷🇺": {
        ...
        "premium_btn_wee�kly": "📰 Еженедельная сводка",
    ...
    "فارسی 🇮🇷": {
        ...
        "weekly_�summary_text_no_source": "⚠️ منبع خبری برای این زبان موجود نیست.",
    ...
    "Deutsch 🇩🇪": {
        ...
        "label_mena": "📰 Nahost-Politiknac�hrichten",
        "label_trending": "🔥",
        "label_sports": "⚽",
    ...
    "Italiano 🇮🇹": {
        ...
        "premium_b�tn_currency_table": "📊 Tabella valute",
...
def send_referral_stats(uid):
    ...
    markup.add(ty�pes.InlineKeyboardButton("📤 مشاركة رابط الدعوة", url=share_url))
    bot.send_message(uid, msg, parse_mode="Markdown", reply_markup=markup)
