...
MSGS = {
    ...
    "فارسی 🇮🇷": {
        ...
        "share_bot_head�er": "📢 *ربات را به اشتراک بگذارید و کمک کنید رشد کند!*\n\n🔗 *لینک ربات:*\n@{username}\n\n📌 یا از طریق لینک:\n`{link}`\n\n━━━━━━━━━━━━━━━\n💡 با دوستان به اشتراک بگذارید:",
    ...
    "Türkçe 🇹🇷": {
     ...
     �   "weather_error": "⚠️ Hava durumu verisi alınamıyor.",
        ...
        "currency_alert_invalid": "❌ Bir sayı gönderin, örn�ek: 1600",
...
def send_prayer_times(uid):
    ...
    try:
        ...
        msg = t(lang, "pray�er_header").format(
...
def cb_alerts_show_track(call):
    ...
    for sym in assets:
        ...
        msg += f"• {format_asset_price(sym, price or last_prices.get(sym))}\n"
    msg += f"━━━━━━━━━━━━━━\n🤖 @{BOT_USERNAME}"
    bot.send_message(uid, msg, parse�_mode="Markdown")
