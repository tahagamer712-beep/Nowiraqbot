...
# ════════════════════════════════════════════════════════════════════
_db_lock           = _legacy._db_lock
_db_conn           = _legacy._db_conn
_save_users        = _legacy._save_users
safe_send_message  = _legacy.safe_send_message
_news_importance_score = _legacy._news_importance_score
...
_ai_generate       = getattr(_legacy, "_ai_generate", lambda p: "")
